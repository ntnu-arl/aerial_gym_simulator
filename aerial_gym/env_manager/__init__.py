...
from aerial_gym.config.env_config.env_with_lidar_nav_obstacles import EnvWithLidarNavObstaclesCfg
...
env_config_registry.register("env_with_lidar_nav_obstacles", EnvWithLidarNavObstaclesCfg)
