...
from aerial_gym.config.sensor_config.lidar_config.rslidar_airy_config import RSLidar_Airy_Config
...
class MagpieCfg:
    ...
    class sensor_config:
        ...
        enable_lidar = True
        lidar_config = RSLidar_Airy_Config
